...
<div id="text"><div>
	...
	<td id="t2">
	<h1>Разделительный трансф. 2000 Вт </h1>
<div id="cat_div">
...
<tr><td id="cat_t4">Номинальный ток, А</td><td id="cat_t4">17 / 8,5</td></tr>
...
<br><br><br>
<img src="http://npptranstech.com/images/transformers/1.jpg" alt="" border="0" class='imgl'><h1>Безопасность и предотвращение гальванической коррозии</h1>
