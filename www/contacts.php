...
$modes = array("автономное электроснабжение, инверторы, преобразователи напряжения, Зарядные устройства, Xantrex, НПП Транстехника, Транстехника, инвертор, преобразователь, Виктрон, Victron Energy, нет света, свет, альтернативная энергия, дилер Victron Energy, свет загородом, нет света на даче, нет электричества");
head("Контакты", $modes);
?>
   <div id="text"><div>
...
Тел.: &nbsp;+7 (812) 444-61-16<br>
<font color = "#ffffff">Тел.: &nbsp;</font>+7 (921) 937-35-76<br>
Факс: +7 (812) 444-61-16
